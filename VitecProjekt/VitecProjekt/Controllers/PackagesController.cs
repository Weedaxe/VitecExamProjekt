...
namespace VitecProjekt.Controllers
{
    public class PackagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PackageID,product")] Package package)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PackageID,product")] Package package)
        {
